...
var crime = new Chart(crimen, {
    type: 'bar',
    data: {
        labels: ['Disclosure of identity of victims', 'Griveous Hurt', 
        'Kidnapping and Abduction', 'Torture', 
        'Causing injury under rash driving/ Road rage', 
        'Causing of Identity of victims', 'Extorion', 
        'Offences prompting entity between different groups'],
        datasets: [{
            label: 'Crime No.',
            data: [4, 4, 1, 13, 2, 4, 4, 5],
            backgroundColor: [
                'rgba(199,22,31,1)',
                'rgba(39,36,251,1)',
                'rgba(40,167,45,1)',
